...
public class SwarmNioServer extends AbstractExecutionThreadService {
	...
	@Inject
	SwarmNioServer(EventBus eventBus, SwarmConfig swarmConfig, BaseSwarmMessageSerde baseSwarmMessageSerde) {
	...
	protected void startUp() throws Exception {
		...
		InetSocketAddress inetSocketAddress = InetSocketAddress.createUnresolved(localNode.getHost(), localNode.getPort());
	...
	protected void run() throws Exception {
		...
		while(true) {
			InetSocketAddress sender = (InetSocketAddress) datagramChannel.receive(incoming);
